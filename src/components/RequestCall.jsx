...
//         <div
//           ref={form}
//           className=" pt-40 relative  flex justify-center font-serif "
//         >
//           <div className="grid grid-cols-2   p-4 relative z-10">
...
//                 We here to help with any questions about our projects, programs
//                 or events. Reach out and let us know how we can assist you in
//                 software journey
//               </p>
//             </div>
//             <div>
//               <form action="" className="space-y-4  mx-10 " onSubmit={handleForm}>
//               <Input
//                   type="text"
//                   value={formData?.name}
//                   name="name"
...
//                 <button
//                   // type="submit"
//                   className="px-6 py-2 rounded-lg bg-black text-white font-medium focus:outline-none "
...
//           //   width: 1000px;
//           //   height: 1000px;
//           background: linear-gradient(rgba(169, 75, 40, 0.5), rgba(169, 75, 40, 0.5)),
...
const RequestCall = () => {
  ...
  return (
    <>
      <div className="font-serif h-[90vh] bgImage" style={{ marginTop: "" }}>
        <div ref={form} className="z-20 sm:pt-40 pt-10 relative flex justify-center font-serif">
          <div className="grid sm:grid-cols-2 grid-cols-1  p-4 relative z-10">
            <div className="h-full">
              ...
              <p className="text-white max-w-lg mx-auto my-2 text-sm text-center">
                We are here to help with any questions about our projects, programs, or events. Reach out and let us know how we can assist you in your software journey.
              </p>
            </div>
            <div>
